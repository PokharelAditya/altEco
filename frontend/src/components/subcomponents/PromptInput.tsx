  ...
  return (
    <>
      <div className="flex-col mx-auto pt-4 max-w-4xl">
        ...
        />
        <button className="ml-auto flex items-center gap-2 mt-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 hover:shadow-md cursor-pointer transition-all duration-300">
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
